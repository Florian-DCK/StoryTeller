...
<body class="bg-background flex flex-col">
    ...
    <h1 class="font-family-joan text-2xl mt-4 mb-4 text-center w-full">Vos Histoires Likées</h1>
    ...
    lazyLoadStories("/serve/stories?liked_by=<?php echo $_SESSION['userId']; ?>");
    </script>
</body>
